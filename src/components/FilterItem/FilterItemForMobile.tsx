    ...
    <div className="relative">
      <div className="mt-[-12px]">
        <button
          ...
          className="w-[94px] h-[39px] border-[1px] border-[#999] bg-white rounded-[40px] flex justify-center items-center gap-[6px] text-[14px] text-secondaryColor font-Noto-Sans-Bengali font-normal"
      ...
      {isModalOpen && (
        <div
          ref={modalRef}
          className="absolute top-[50px] right-0 z-30 w-[224px] bg-white  rounded-[6px] p-4"
...
export default FilterItemForMobile;
