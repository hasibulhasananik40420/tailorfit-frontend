...
import CustomerEditModal from "../../../pages/user/customers/CustomerEditModal";
import {
...
const ActionModalCustomers = ({
  ...
  const [deleteCostumer] = useDeleteCostumerMutation();
  // console.log(id)
  ...
  const handleDelete = async (id: string) => {
    try {
      ...
      if (result.isConfirmed) {
        const res = await deleteCostumer(id).unwrap();
  ...
  const openCustomerEditModal = (event: React.MouseEvent) => {
      ...
      <div>
        {isOpen && (
          <div
            ...
            className=" h-[104px] bg-white w-[126px] rounded-[5px] p-[10px] mt-10 "
          >
            <div>
              {industry ? (
                <div>
...
export default ActionModalCustomers;
