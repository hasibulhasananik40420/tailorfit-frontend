...
import PersonOderList from "../../../pages/user/PersonOderList";
import CompanyOrderList from "../../../pages/user/CompanyOrderList";
import FilterItem from "../../FilterItem/FilterItem";
import FilterItemForMobile from "../../FilterItem/FilterItemForMobile";

const OrderTabAndList = () => {
  const [activeTab, setActiveTab] = useState("person");

  return (
    <div className="w-full">
      <h1 className="text-secondaryColor text-[18px] font-Noto-Sans-Bengali font-semibold lg:hidden block mb-4">
        অর্ডার তালিকা
      </h1>
      ...
      <div className="w-full">
        {activeTab === "person" && <PersonOderList />}
        {activeTab === "company" && <CompanyOrderList />}
      </div>
    </div>
  );
};

export default OrderTabAndList;
