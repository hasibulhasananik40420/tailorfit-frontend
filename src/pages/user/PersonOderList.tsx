  ...
  return (
    <div className="">
      {filteredOrdersByStatus?.length > 0 ? (
            ...
            <tbody className="">
              {filteredOrdersByStatus?.map(
                (order: TIndividualOrder, orderIndex: number) => (
                  <>
                    <tr key={orderIndex} className="bg-white border-b border-dashed">
                      <th
                        scope="row"
                      ...
                      <th
                        ...
                        // ${
                        //   dropdownOpen === order?.orderId ? "pointer-events-none" : ""
                        // }
                      >
        ...
        <div className="flex items-center justify-center gap-4 text-[24px] text-center text-switchColor font-Noto-Sans-Bengali font-medium  min-h-[300px]">
