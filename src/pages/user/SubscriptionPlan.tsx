...
const SubscriptionPlan = () => {
  return (
    <div className="2xl:pt-[50px] lg:pt-[30px] pt-5">
      <h1 className="md:text-[28px] text-[24px] text-[#333] font-Poppins font-semibold">
        Choose your best plan
      </h1>
     

      <div className="lg:block hidden">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-[30px]  md:mt-[34px] mt-10 ">
       ...
       >
         ...
         <div className="2xl:px-[30px] lg:px-5 px-4 2xl:mt-[92px] lg:mt-[30px] mt-5">
         ...
         <div className="2xl:px-[30px] lg:px-5 px-4 flex flex-col gap-[18px] lg:mt-[30px] mt-5">
       ...
       <div className="lg:hidden block mt-[20px] mb-6">
          <SubscriptionPlanForMobile/>
       </div>
