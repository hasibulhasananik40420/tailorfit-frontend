...
const CompanyNewOrderOptionarl = () => {
                  ...
                  <div className="flex md:gap-5 gap-2 items-center">
                    ...
                    <div className="">
                      <IoIosArrowDown
                        ...
                        className={`md:size-6 size-3 text-black cursor-pointer rotate-180 ${
                          form.isVisible && "rotate-0"
                        }`}
                      />
                    </div>
                  </div>
...
export default CompanyNewOrderOptionarl;
