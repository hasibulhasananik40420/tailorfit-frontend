...
const IndivisualNewOrder = () => {
  ...
  const handlePocketSelect = (index: number, style: string) => {
    const updatedForms = [...forms];
    updatedForms[index].pocketStyle = style;
  ...
  const onSubmit = async (data: FieldValues) => {
    ...
    if (selectedDate) {
      data.orderDate = format(selectedDate, 'dd-MM-yyyy');
    }
    if (selectedDateTwo) {
      data.tryerDate = format(selectedDateTwo, 'dd-MM-yyyy');
    }
    if (selectedDateThree) {
      data.deliveryDate = format(selectedDateThree, 'dd-MM-yyyy');
    }
  ...
  return (
    ...
    >
      ...
      <div className="2xl:pt-[30px] lg:pt-[15px] pt-3 relative">
        ...
        {forms.map((form, i) => (
          <>
            ...
            >
              <div className="lg:flex justify-between items-center lg:p-5 p-3">
                  ...
                  {measurementsData?.data?.find(
                    ...
                    <>
                      <div className=" lg:flex bg-[#F9FAFE] rounded-r-[10px] rounded-l-[10px] border-[#BCBEC6] border-t rounded-t-none ">
                              ...
                              {measurementsData.data.find(
                                ...
                                (() => {
                                  ...
                                  return (
                                    <div>
                                      <img
                                        className="2xl:w-[252px] lg:w-[220px] w-[106px] 2xl:h-[282px] lg:h-[230px] h-[120px] mr-3 mt-[-190px] ml-[190px] md:mt-0 md:ml-0 opacity-50"
                          ...
                          <div className="2xl:p-5 p-3">
                            ...
                            <div className="lg:mt-5 mt-3 lg:flex flex-row-reverse gap-5 ">
                              <div className="flex flex-col lg:gap-2 2large:gap-2 gap-[12px]">
                                {measurement?.data?.data?.subCategories.map(
                        ...
                        ${
                          form.isChecked
                            ? "border-[#FF5151] bg-activeDhcolor text-[#FF5151]"
                            : "border-[#BCBEC6] bg-white text-black "
                                        ...
                                        >
                                          {/* <input
                                            ...
                                            // }
                                            {...register(`item.${[i]}.style`)}
                                          />

                                          <label className="md:text-[18px] text-[14px] font-Noto-Sans-Bengali font-medium">
                                            {form}
                                          </label> */}
        ...
        <div>
          ...
          <div className="2xl:mt-[30px] mt-5">
            <button
              type="button"
              onClick={addForm}
              className="bg-activeDhcolor w-full h-[50px] rounded-[8px] flex justify-center items-center gap-2 text-[#FF5151] text-[18px] font-medium font-Noto-Sans-Bengali"
            >
      ...
      <div className="flex justify-between items-center mt-[30px]">
        ...
        <button
          type="submit"
          className={`bg-[#FF5151] lg:w-[207px] w-[207px] h-[50px] rounded-[6px] flex justify-center items-center gap-2 text-white text-[18px] font-medium font-Noto-Sans-Bengali`}
        >
...
export default IndivisualNewOrder;
