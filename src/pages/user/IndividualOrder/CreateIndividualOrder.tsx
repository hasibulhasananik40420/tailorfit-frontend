                    ...
                    <div className="lg:flex items-center gap-5 relative lg:w-[340px] w-full md:w-[340px]">
                      ...
                      <div className="relative w-full">
                        ...
                        >
                          ...
                          <IoIosArrowDown className="text-black absolute right-4 size-5" />
                        </div>
                        ...
                        <div className="flex md:gap-5 gap-5 items-center">
                          ...
                          <div className="">
                            <IoIosArrowDown
                              ...
                              className={`md:size-6 size-5 text-black cursor-pointer transition-transform duration-300 ease-in-out ${
                  ...
                  <div className="md:block hidden">
                    <div className="flex md:gap-5 gap-2 items-center">
                      ...
                      <div className="">
                        <IoIosArrowDown
                          onClick={() => toggleVisibility(fromIndex)}
                          className={`md:size-6 size-4 text-black cursor-pointer transition-transform duration-300 ease-in-out ${
                              ...
                              <div className="lg:mt-5 mt-3 lg:flex flex-row-reverse gap-5 ">
                                ...
                                <div className=" mt-[30px] lg:mt-0">
                                      ...
                                      {form?.dropDownStyle?.map(
                                        (
                                          ...
                                          return (
                                            ...
                                            >
                                              <div
                                                className="relative 2xl:w-[340px] 2large:w-[270px] lg:w-[230px] 2makbook:w-[200px] w-full h-[56px] rounded-[8px] border-[1px] border-[#BCBEC6] bg-white text-black outline-0 px-5 md:text-[18px] text-[14px] font-Noto-Sans-Bengali flex items-center justify-between cursor-pointer"
                                                onClick={() =>
                                  ...
                                  <div className="w-full lg:hidden block mt-[30px]">
                                    ...
                                    <input
                                      type="text"
                                      className="w-full h-[60px] border-[1px] border-[#BCBEC6] rounded-[8px] bg-white pl-4 placeholder:text-[18px] font-Noto-Sans-Bengali font-normal placeholder:text-switchColor text-secondaryColor outline-0"
...
export default CreateIndividualOrder;
