      ...
      >
                ...
                <div className="lg:flex items-center justify-end gap-2  mt-4 lg:mt-0">
                  ...
                  <div className="relative">
                    <DatePicker
                      ...
                      className="lg:w-[150px] w-full text-[#651A71] 2xl:text-[18px] lg:text-[16px] text-[14px] rounded-[8px] bg-white outline-0 font-Poppins placeholder:text-secondaryColor cursor-pointer"
          ...
          <div>
            <div className="2xl:mt-[30px] mt-5">
              <button
                type="button"
                onClick={addForm}
                className="bg-activeDhcolor w-full h-[50px] rounded-[8px] flex justify-center items-center gap-2 text-primaryColor text-[18px] font-medium font-Noto-Sans-Bengali"
              >
        ...
        <div className="md:flex md:flex-row-reverse md:justify-between items-center mt-[30px] ">
          <div className="relative bg-white md:flex gap-[10px] items-center">
            ...
            {/* <Menu>
              <MenuButton className="inline-flex items-center gap-2 rounded-[6px] bg-primaryColor py-[13px] px-3 text-white cursor-pointer">
