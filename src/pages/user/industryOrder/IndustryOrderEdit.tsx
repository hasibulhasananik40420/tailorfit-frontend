...
import { useEditCompanyOrderMutation } from "../../../redux/api/companyOrderApi";
import Selector from "../../../components/Selector/Selector";
import ReactToPrint from "react-to-print";
import PDFGenerator from "../../../utils/PDF";
import { Link } from "react-router-dom";

const IndustryOrderEdit = ({
  singleOrder,
}: {
  ...
  const [industry, setIndustry] = useState("" || singleOrder.industry);
  ...
  const [editCompanyOrder, { isLoading }] = useEditCompanyOrderMutation();
  const onSubmit = async () => {
    try {
      const res = await editCompanyOrder(newData).unwrap();
          ...
          <div className="lg:flex lg:gap-5 justify-between mt-5">
            <div className="lg:flex lg:flex-col lg:gap-5  gap-[10px]">
              ...
              <div className="lg:flex items-center justify-between 2xl:gap-[30px] gap-5 2xl:w-[560px] lg:w-[520px] w-full mt-4 lg:mt-0">
                ...
                <Selector
                  setIndustrySelected={setIndustry}
            ...
            <>
              ...
              >
                <div className="flex justify-between items-center lg:p-5 p-3">
                  <div className="lg:flex items-center md:gap-[50px] gap-3">
                            ...
                            <div className="lg:mt-5 mt-3 lg:flex flex-row-reverse gap-5 ">
                              ...
                              <div className=" mt-[30px] lg:mt-0">
                                                ...
                                                {dropDownStyle?.item?.map(
                                                  (
                                                    ...
                                                    <div
                                                      ...
                                                      className="px-[10px] py-[6px] rounded cursor-pointer hover:bg-activeDhcolor text-black"
                                                    >
                                ...
                                <div className="w-full lg:hidden block mt-[30px]">
                                  ...
                                  <input
                                    type="text"
                                    className="w-full h-[60px] border-[1px] border-[#BCBEC6] rounded-[8px] bg-white text-secondaryColor pl-4 placeholder:text-[18px] font-Noto-Sans-Bengali font-normal placeholder:text-switchColor outline-0"
...
export default IndustryOrderEdit;
