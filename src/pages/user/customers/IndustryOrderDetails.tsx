          ...
          <div className="lg:flex justify-between items-center 2xl:pt-[30px] pt-5 lg:px-4 px-3">
            ...
            <div className="flex gap-6 items-center">
              ...
              <div className="w-[37px] relative h-[37px] rounded-[6px] bg-[#F6F6F6] flex justify-center items-center cursor-pointer">
                <HiDotsVertical
                  onClick={() =>
                    toggleActionModal(singleOrder?.orderId as string)
                  }
                ...
                <div className="lg:flex lg:flex-col lg:gap-5  gap-[10px]">
                  ...
                  <div className="lg:flex items-center justify-between 2xl:gap-[30px] gap-5 2xl:w-[560px] lg:w-[520px] w-full mt-4 lg:mt-0">
                    ...
                    <input
                      ...
                      readOnly
                      defaultValue={
                        (singleOrder?.address as string)
                          ? (singleOrder?.address as string)
                          : (singleOrder?.industry as string)
                      }
                    />
                  </div>
                </div>
                  ...
                  <>
                    ...
                    >
                      <div className="flex justify-between items-center lg:p-5 p-3">
                        <div className="lg:flex md:gap-[50px] gap-3">
                                            ...
                                            (
                                              ...
                                              return (
                                                <div
                                                  ...
                                                  className="flex flex-col"
                                                >
                                                  <div className="text-black relative 2xl:w-[340px] 2large:w-[270px] lg:w-[230px] 2makbook:w-[200px] w-full h-[56px] rounded-[8px] border-[1px] border-[#BCBEC6] bg-white outline-0 px-5 md:text-[18px] text-[14px] font-Noto-Sans-Bengali flex items-center justify-between cursor-pointer">
...
export default IndustryOrderDetails;
